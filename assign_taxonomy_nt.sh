...
# Assigns taxonomy to nt blast searches, using the program ete3 and a script from David Ryder (originally LookupTaxonoDetails.py)
...
Usage:
	-b  Blast file including column with staxids
	-c  Number of the column containing staxids
