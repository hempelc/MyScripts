...
# SILVA taxonomy file can be found under /hdd1/databases/SILVA_database_mar_2020/taxonomy/taxmap_ncbi_ssu_ref_nr99_138_with_staxid.txt 
...
df1 = pd.read_csv(df1_name, sep='\t', names=['qseqid', 'sseqid', 'pident', 'length', 'mismatch', 'gapopen', 'qstart', 'qend', 'sstart', 'send', 'evalue', 'bitscore', 'staxid'])
