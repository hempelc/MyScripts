...
# Made by Natalie Wright (Uni of Guelph) in April 2020

# A script to run several assemblers on a set of reads and if wanted map reads
# back to contigs and taxonomically annotate contigs
...
Usage:
	...
	-D Flag to use complete pipeline only for DNA assemblers
	-R Flag to use complete pipeline only for RNA assemblers
